 ...
 *
 * Disassembly of DSDT.aml, Sun Dec 18 14:06:31 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00019925 (104741)
 *     Revision         0x02
 *     Checksum         0xBB
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x87B97000, 0x0633)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0x874CFF18, 0x10)
        ...
        Method (_L6F, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If ((VGAS == Zero))
            {
                If ((S3NV == Zero))
                {
                    TMP3 = Zero
                    TMP3 = (\_SB.GGIV (0x01080000) | \_SB.GGIV (0x01080001))
                    TMP3 |= \_SB.GGIV (0x01080002) /* \_GPE._L6F.TMP3 */
                    If (TMP3)
                    {
                        P80H = 0x78
                        Sleep (0x64)
            ...
            Method (SCMD, 3, Serialized)
            {
                ...
                If ((ToInteger (Arg1) == 0x79))
                {
                    ...
                    While (One)
                    {
                        ...
                        ElseIf ((_T_4 == 0x10))
                        {
                            ^^PCI0.SBUS.SWRB (0xE6, ((Local2 >> 0x08) & 0xFF), (Local2 & 0xFF
                                ))
                        }
